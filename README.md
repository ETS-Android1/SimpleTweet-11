...
- [x] User is using **"Twitter branded" colors and styles** *(from part 1)*
- [x] User can click links in tweets launch the web browser *(from part 1)*
- [ ] User can **select "reply" from detail view to respond to a tweet**
- [x] The "Compose" action is moved to a FloatingActionButton instead of on the AppBar
- [ ] Compose tweet functionality is build using modal overlay
- [x] Use Parcelable instead of Serializable using the popular [Parceler library](http://guides.codepath.org/android/Using-Parceler) *(we already used Parceler from the tutorial videos)*.
...
- [Time Formatter](https://github.com/nesquena/TimeFormatter) - Java class that formats time strings received from the Twitter API into the relative time difference.

## License

    Copyright [2021] [Yusef Mustafa]
